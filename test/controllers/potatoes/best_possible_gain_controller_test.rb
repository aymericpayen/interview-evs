...
class Potatoes::BestPossibleGainControllerTest < ActionDispatch::IntegrationTest
  test "returns 422 when no params provided" do
    ...
    test "returns 204 when invalid params provided" do
  ...
  test "returns 200 and max_gain = 0 when only one price record" do
    PotatoPrice.create!(time: '2022-08-22T09:00:00.000Z', value: 100.25)
  ...
  test 'returns 200 and max_gain = 6 when prices fluctuates positively during the day' do
